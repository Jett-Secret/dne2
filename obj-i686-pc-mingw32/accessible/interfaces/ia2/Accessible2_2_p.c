 ...
 */
/* Compiler settings for d:/Projects/DanknetExplorer/dne2/platform/other-licenses/ia2/Accessible2_2.idl:
...
typedef struct _Accessible2_2_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } Accessible2_2_MIDL_TYPE_FORMAT_STRING;

typedef struct _Accessible2_2_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } Accessible2_2_MIDL_PROC_FORMAT_STRING;

typedef struct _Accessible2_2_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } Accessible2_2_MIDL_EXPR_FORMAT_STRING;
...
extern const Accessible2_2_MIDL_TYPE_FORMAT_STRING Accessible2_2__MIDL_TypeFormatString;
extern const Accessible2_2_MIDL_PROC_FORMAT_STRING Accessible2_2__MIDL_ProcFormatString;
extern const Accessible2_2_MIDL_EXPR_FORMAT_STRING Accessible2_2__MIDL_ExprFormatString;
...
static const Accessible2_2_MIDL_PROC_FORMAT_STRING Accessible2_2__MIDL_ProcFormatString =
    {
        0,
        {
...
/* 124 */	NdrFcShort( 0x424 ),	/* Type Offset=1060 */
...
static const Accessible2_2_MIDL_TYPE_FORMAT_STRING Accessible2_2__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* 1054 */	NdrFcShort( 0xfd44 ),	/* Offset= -700 (354) */
/* 1056 */	
...
/* 1072 */	0x28,		/* Corr desc:  parameter, FC_LONG */
			0x54,		/* FC_DEREFERENCE */
/* 1074 */	NdrFcShort( 0x10 ),	/* x86 Stack size/offset = 16 */
/* 1076 */	NdrFcShort( 0x0 ),	/* Corr flags:  */
/* 1078 */	NdrFcLong( 0xffffffff ),	/* -1 */
/* 1082 */	NdrFcShort( 0x0 ),	/* Corr flags:  */
...
static const MIDL_STUBLESS_PROXY_INFO IAccessible2_2_ProxyInfo =
    {
    &Object_StubDesc,
    Accessible2_2__MIDL_ProcFormatString.Format,
...
CINTERFACE_PROXY_VTABLE(49) _IAccessible2_2ProxyVtbl = 
{
    ...
    0 /* IAccessible2::get_nRelations */ ,
    0 /* IAccessible2::get_relation */ ,
    0 /* IAccessible2::get_relations */ ,
    0 /* IAccessible2::role */ ,
    0 /* IAccessible2::scrollTo */ ,
    0 /* IAccessible2::scrollToPoint */ ,
    0 /* IAccessible2::get_groupPosition */ ,
    0 /* IAccessible2::get_states */ ,
    0 /* IAccessible2::get_extendedRole */ ,
    0 /* IAccessible2::get_localizedExtendedRole */ ,
    0 /* IAccessible2::get_nExtendedStates */ ,
    0 /* IAccessible2::get_extendedStates */ ,
    0 /* IAccessible2::get_localizedExtendedStates */ ,
    0 /* IAccessible2::get_uniqueID */ ,
    0 /* IAccessible2::get_windowHandle */ ,
    0 /* IAccessible2::get_indexInParent */ ,
    0 /* IAccessible2::get_locale */ ,
    0 /* IAccessible2::get_attributes */ ,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    Accessible2_2__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _Accessible2_2_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IAccessible2_2ProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _Accessible2_2_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IAccessible2_2StubVtbl,
    0
};

PCInterfaceName const _Accessible2_2_InterfaceNamesList[] = 
{
    "IAccessible2_2",
    0
};

const IID *  const _Accessible2_2_BaseIIDList[] = 
{
    &IID_IAccessible2,
    0
};
...
#define _Accessible2_2_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _Accessible2_2, pIID, n)

int __stdcall _Accessible2_2_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_Accessible2_2_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo Accessible2_2_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _Accessible2_2_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Accessible2_2_StubVtblList,
    (const PCInterfaceName * ) & _Accessible2_2_InterfaceNamesList,
    (const IID ** ) & _Accessible2_2_BaseIIDList,
    & _Accessible2_2_IID_Lookup, 
    1,
    2,
