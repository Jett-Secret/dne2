...
toggleAttribute(JSContext* cx, JS::Handle<JSObject*> obj, mozilla::dom::Element* self, const JSJitMethodCallArgs& args)
{
  ...
  bool result(self->ToggleAttribute(NonNullHelper(Constify(arg0)), Constify(arg1), rv));
...
static const JSFunctionSpec sMethods_specs[] = {
  ...
  JS_FNSPEC("toggleAttribute", GenericBindingMethod, reinterpret_cast<const JSJitInfo*>(&toggleAttribute_methodinfo), 1, JSPROP_ENUMERATE, nullptr),
  ...
  JS_FNSPEC("hasPointerCapture", GenericBindingMethod, reinterpret_cast<const JSJitInfo*>(&hasPointerCapture_methodinfo), 1, JSPROP_ENUMERATE, nullptr),
  JS_FS_END,
  ...
  JS_FS_END,
  JS_FNSPEC("attachShadow", GenericBindingMethod, reinterpret_cast<const JSJitInfo*>(&attachShadow_methodinfo), 1, JSPROP_ENUMERATE, nullptr),
  ...
  JS_FNSPEC("requestPointerLock", GenericBindingMethod, reinterpret_cast<const JSJitInfo*>(&requestPointerLock_methodinfo), 0, JSPROP_ENUMERATE, nullptr),
  JS_FS_END,
  ...
  JS_FS_END,
  JS_FNSPEC("prepend", GenericBindingMethod, reinterpret_cast<const JSJitInfo*>(&prepend_methodinfo), 0, JSPROP_ENUMERATE, nullptr),
  JS_FNSPEC("append", GenericBindingMethod, reinterpret_cast<const JSJitInfo*>(&append_methodinfo), 0, JSPROP_ENUMERATE, nullptr),
  JS_FS_END
};
...
static PrefableDisablers sMethods_disablers45 = {
...
static PrefableDisablers sMethods_disablers52 = {
  true, false, 0, &nsDocument::IsElementAnimateEnabled
};
...
static PrefableDisablers sMethods_disablers67 = {
  true, false, 0, &WantsQueryInterface<mozilla::dom::Element>::Enabled
};
...
static const JSFunctionSpec sChromeMethods_specs[] = {
  ...
  JS_FNSPEC("getGridFragments", GenericBindingMethod, reinterpret_cast<const JSJitInfo*>(&getGridFragments_methodinfo), 0, JSPROP_ENUMERATE, nullptr),
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  { "assignedSlot", JSPROP_SHARED | JSPROP_ENUMERATE, { { { { GenericBindingGetter, &assignedSlot_getterinfo } }, JSNATIVE_WRAPPER(nullptr) } } },
  { "slot", JSPROP_SHARED | JSPROP_ENUMERATE, { { { { GenericBindingGetter, &slot_getterinfo } }, { { GenericBindingSetter, &slot_setterinfo } } } } },
  JS_PS_END,
...
static jsid sAttributes_ids[33];
...
CreateInterfaceObjects(JSContext* aCx, JS::Handle<JSObject*> aGlobal, ProtoAndIfaceCache& aProtoAndIfaceCache, bool aDefineOnGlobal)
{
  ...
  if (!sPrefCachesInited && NS_IsMainThread()) {
    ...
    Preferences::AddBoolVarCache(&sMethods[6].disablers->enabled, "pointer-lock-api.prefixed.enabled");
...
GetProtoObjectHandle(JSContext* aCx)
{
  ...
  const JS::Heap<JSObject*>& entrySlot = protoAndIfaceCache.EntrySlotMustExist(prototypes::id::Element);
...
GetConstructorObjectHandle(JSContext* aCx, bool aDefineOnGlobal)
{
  ...
  const JS::Heap<JSObject*>& entrySlot = protoAndIfaceCache.EntrySlotMustExist(constructors::id::Element);
  MOZ_ASSERT_IF(entrySlot, !JS::ObjectIsMarkedGray(entrySlot));
  return JS::Handle<JSObject*>::fromMarkedLocation(entrySlot.address());
}
