...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  { "surfaceScale", JSPROP_SHARED | JSPROP_ENUMERATE, { { { { GenericBindingGetter, &surfaceScale_getterinfo } }, JSNATIVE_WRAPPER(nullptr) } } },
  { "specularConstant", JSPROP_SHARED | JSPROP_ENUMERATE, { { { { GenericBindingGetter, &specularConstant_getterinfo } }, JSNATIVE_WRAPPER(nullptr) } } },
  { "specularExponent", JSPROP_SHARED | JSPROP_ENUMERATE, { { { { GenericBindingGetter, &specularExponent_getterinfo } }, JSNATIVE_WRAPPER(nullptr) } } },
  { "kernelUnitLengthX", JSPROP_SHARED | JSPROP_ENUMERATE, { { { { GenericBindingGetter, &kernelUnitLengthX_getterinfo } }, JSNATIVE_WRAPPER(nullptr) } } },
  { "kernelUnitLengthY", JSPROP_SHARED | JSPROP_ENUMERATE, { { { { GenericBindingGetter, &kernelUnitLengthY_getterinfo } }, JSNATIVE_WRAPPER(nullptr) } } },
...
GetProtoObjectHandle(JSContext* aCx)
{
  ...
  if (!protoAndIfaceCache.EntrySlotIfExists(prototypes::id::SVGFESpecularLightingElement)) {
  ...
  const JS::Heap<JSObject*>& entrySlot = protoAndIfaceCache.EntrySlotMustExist(prototypes::id::SVGFESpecularLightingElement);
...
GetConstructorObjectHandle(JSContext* aCx, bool aDefineOnGlobal)
{
  ...
  /* Check to see whether the interface objects are already installed */
  ProtoAndIfaceCache& protoAndIfaceCache = *GetProtoAndIfaceCache(global);
  if (!protoAndIfaceCache.EntrySlotIfExists(constructors::id::SVGFESpecularLightingElement)) {
    JS::Rooted<JSObject*> rootedGlobal(aCx, global);
    CreateInterfaceObjects(aCx, rootedGlobal, protoAndIfaceCache, aDefineOnGlobal);
  }
  ...
  const JS::Heap<JSObject*>& entrySlot = protoAndIfaceCache.EntrySlotMustExist(constructors::id::SVGFESpecularLightingElement);
  MOZ_ASSERT_IF(entrySlot, !JS::ObjectIsMarkedGray(entrySlot));
  return JS::Handle<JSObject*>::fromMarkedLocation(entrySlot.address());
}
