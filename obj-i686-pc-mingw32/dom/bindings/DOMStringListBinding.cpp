...
static bool
get_length(JSContext* cx, JS::Handle<JSObject*> obj, mozilla::dom::DOMStringList* self, JSJitGetterCallArgs args)
{
...
static const JSJitInfo length_getterinfo = {
  ...
  { prototypes::id::DOMStringList },
  { PrototypeTraits<prototypes::id::DOMStringList>::Depth },
  JSJitInfo::Getter,
...
static bool
item(JSContext* cx, JS::Handle<JSObject*> obj, mozilla::dom::DOMStringList* self, const JSJitMethodCallArgs& args)
{
  if (MOZ_UNLIKELY(args.length() < 1)) {
    return ThrowErrorMessage(cx, MSG_MISSING_ARGUMENTS, "DOMStringList.item");
  }
  uint32_t arg0;
...
static bool
contains(JSContext* cx, JS::Handle<JSObject*> obj, mozilla::dom::DOMStringList* self, const JSJitMethodCallArgs& args)
{
  if (MOZ_UNLIKELY(args.length() < 1)) {
    return ThrowErrorMessage(cx, MSG_MISSING_ARGUMENTS, "DOMStringList.contains");
  }
...
{
  mozilla::dom::DOMStringList* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::DOMStringList>(obj);
  if (self) {
...
static_assert(IsBaseOf<nsISupports, mozilla::dom::DOMStringList >::value,
...
MOZ_ALWAYS_INLINE mozilla::dom::DOMStringList*
UnwrapProxy(JSObject* obj)
{
  ...
  return static_cast<mozilla::dom::DOMStringList*>(js::GetProxyPrivate(obj).toPrivate());
}
...
DOMProxyHandler::getOwnPropDescriptor(JSContext* cx, JS::Handle<JSObject*> proxy, JS::Handle<jsid> id, bool ignoreNamedProps, JS::MutableHandle<JS::PropertyDescriptor> desc) const
{
  ...
  if (IsArrayIndex(index)) {
    mozilla::dom::DOMStringList* self = UnwrapProxy(proxy);
    bool found = false;
    DOMString result;
...
{
  mozilla::dom::DOMStringList* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::DOMStringList>(proxy);
  if (self) {
    ClearWrapper(self, self);
    AddForDeferredFinalization<mozilla::dom::DOMStringList>(self);
  }
}
...
static const DOMJSClass sClass = {
  PROXY_CLASS_WITH_EXT("DOMStringList",
                       JSCLASS_IS_DOMJSCLASS,
                       &sClassExtension),
  { prototypes::id::DOMStringList, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  IsBaseOf<nsISupports, mozilla::dom::DOMStringList >::value,
  sNativePropertyHooks,
  FindAssociatedGlobalForNative<mozilla::dom::DOMStringList>::Get,
  GetProtoObjectHandle,
  GetCCParticipant<mozilla::dom::DOMStringList>::Get()
};
...
{
  MOZ_ASSERT(static_cast<mozilla::dom::DOMStringList*>(aObject) ==
             reinterpret_cast<mozilla::dom::DOMStringList*>(aObject),
             "Multiple inheritance for mozilla::dom::DOMStringList is broken.");
  ...
  BindingJSObjectCreator<mozilla::dom::DOMStringList> creator(aCx);
...
CreateInterfaceObjects(JSContext* aCx, JS::Handle<JSObject*> aGlobal, ProtoAndIfaceCache& aProtoAndIfaceCache, bool aDefineOnGlobal)
{
  ...
  JS::Heap<JSObject*>* protoCache = &aProtoAndIfaceCache.EntrySlotOrCreate(prototypes::id::DOMStringList);
  JS::Heap<JSObject*>* interfaceCache = &aProtoAndIfaceCache.EntrySlotOrCreate(constructors::id::DOMStringList);
...
GetProtoObjectHandle(JSContext* aCx)
{
  ...
  if (!protoAndIfaceCache.EntrySlotIfExists(prototypes::id::DOMStringList)) {
  ...
  const JS::Heap<JSObject*>& entrySlot = protoAndIfaceCache.EntrySlotMustExist(prototypes::id::DOMStringList);
...
GetConstructorObjectHandle(JSContext* aCx, bool aDefineOnGlobal)
{
  ...
  /* Check to see whether the interface objects are already installed */
  ProtoAndIfaceCache& protoAndIfaceCache = *GetProtoAndIfaceCache(global);
  if (!protoAndIfaceCache.EntrySlotIfExists(constructors::id::DOMStringList)) {
    JS::Rooted<JSObject*> rootedGlobal(aCx, global);
    CreateInterfaceObjects(aCx, rootedGlobal, protoAndIfaceCache, aDefineOnGlobal);
  }
  ...
  const JS::Heap<JSObject*>& entrySlot = protoAndIfaceCache.EntrySlotMustExist(constructors::id::DOMStringList);
  MOZ_ASSERT_IF(entrySlot, !JS::ObjectIsMarkedGray(entrySlot));
  return JS::Handle<JSObject*>::fromMarkedLocation(entrySlot.address());
}
