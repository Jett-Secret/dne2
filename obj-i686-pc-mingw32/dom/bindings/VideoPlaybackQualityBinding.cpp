...
static const JSPropertySpec sAttributes_specs[] = {
  { "creationTime", JSPROP_SHARED | JSPROP_ENUMERATE, { { { { GenericBindingGetter, &creationTime_getterinfo } }, JSNATIVE_WRAPPER(nullptr) } } },
  { "totalVideoFrames", JSPROP_SHARED | JSPROP_ENUMERATE, { { { { GenericBindingGetter, &totalVideoFrames_getterinfo } }, JSNATIVE_WRAPPER(nullptr) } } },
  { "droppedVideoFrames", JSPROP_SHARED | JSPROP_ENUMERATE, { { { { GenericBindingGetter, &droppedVideoFrames_getterinfo } }, JSNATIVE_WRAPPER(nullptr) } } },
  { "corruptedVideoFrames", JSPROP_SHARED | JSPROP_ENUMERATE, { { { { GenericBindingGetter, &corruptedVideoFrames_getterinfo } }, JSNATIVE_WRAPPER(nullptr) } } },
  JS_PS_END
};
...
GetProtoObjectHandle(JSContext* aCx)
{
  ...
  if (!protoAndIfaceCache.EntrySlotIfExists(prototypes::id::VideoPlaybackQuality)) {
  ...
  const JS::Heap<JSObject*>& entrySlot = protoAndIfaceCache.EntrySlotMustExist(prototypes::id::VideoPlaybackQuality);
...
GetConstructorObjectHandle(JSContext* aCx, bool aDefineOnGlobal)
{
  ...
  /* Check to see whether the interface objects are already installed */
  ProtoAndIfaceCache& protoAndIfaceCache = *GetProtoAndIfaceCache(global);
  if (!protoAndIfaceCache.EntrySlotIfExists(constructors::id::VideoPlaybackQuality)) {
    JS::Rooted<JSObject*> rootedGlobal(aCx, global);
    CreateInterfaceObjects(aCx, rootedGlobal, protoAndIfaceCache, aDefineOnGlobal);
  }
  ...
  const JS::Heap<JSObject*>& entrySlot = protoAndIfaceCache.EntrySlotMustExist(constructors::id::VideoPlaybackQuality);
  MOZ_ASSERT_IF(entrySlot, !JS::ObjectIsMarkedGray(entrySlot));
  return JS::Handle<JSObject*>::fromMarkedLocation(entrySlot.address());
}
