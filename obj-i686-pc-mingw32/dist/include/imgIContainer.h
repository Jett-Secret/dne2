...
class NS_NO_VTABLE imgIContainer : public nsISupports {
 public:
  ...
  NS_IMETHOD GetIntrinsicRatio(mozilla::AspectRatio *aIntrinsicRatio) = 0;
...
#define NS_DECL_IMGICONTAINER \
  ...
  NS_IMETHOD GetIntrinsicRatio(mozilla::AspectRatio *aIntrinsicRatio) override; \
...
#define NS_DECL_NON_VIRTUAL_IMGICONTAINER \
  ...
  NS_METHOD GetIntrinsicRatio(mozilla::AspectRatio *aIntrinsicRatio); \
...
#define NS_FORWARD_IMGICONTAINER(_to) \
  ...
  NS_IMETHOD GetIntrinsicRatio(mozilla::AspectRatio *aIntrinsicRatio) override { return _to GetIntrinsicRatio(aIntrinsicRatio); } \
...
#define NS_FORWARD_SAFE_IMGICONTAINER(_to) \
  ...
  NS_IMETHOD GetIntrinsicRatio(mozilla::AspectRatio *aIntrinsicRatio) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIntrinsicRatio(aIntrinsicRatio); } \
  virtual nsIntSize OptimalImageSizeForDest(const gfxSize & aDest, uint32_t aWhichFrame, mozilla::gfx::SamplingFilter aSamplingFilter, uint32_t aFlags) override; \
...
/* [noscript] readonly attribute AspectRatio intrinsicRatio; */
NS_IMETHODIMP _MYCLASS_::GetIntrinsicRatio(mozilla::AspectRatio *aIntrinsicRatio)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
