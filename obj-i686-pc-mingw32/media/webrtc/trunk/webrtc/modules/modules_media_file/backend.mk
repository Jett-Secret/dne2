...
LOCAL_INCLUDES += -I$(topsrcdir)/media/webrtc/trunk/webrtc/common_audio/resampler/include
LOCAL_INCLUDES += -I$(topsrcdir)/media/webrtc/trunk/webrtc/common_audio/signal_processing/include
LOCAL_INCLUDES += -I$(topsrcdir)/media/webrtc/trunk/webrtc/common_audio/vad/include
...
UNIFIED_CPPSRCS := Unified_cpp_webrtc_modules0.cpp
CPPSRCS += $(UNIFIED_CPPSRCS)
ALLOW_COMPILER_WARNINGS := 1
DISABLE_STL_WRAPPING := 1
IS_GYP_DIR := 1
RTL_FLAGS += -MD
LIBRARY_NAME := media_file
FORCE_STATIC_LIB := 1
REAL_LIBRARY := media_file.lib
