...
MOZ_APP_BASENAME=Danknet_Explorer
MOZ_APP_VENDOR=Lynx_Point
MOZ_PHOENIX=1
MOZ_AUSTRALIS=1
MC_BASILISK=1
MOZ_UPDATER=
...
MOZ_BRANDING_DIRECTORY=basilisk/branding/dankbranding
MOZ_OFFICIAL_BRANDING_DIRECTORY=basilisk/branding/dankbranding
...
NSS_DISABLE_DBM=1
# Title bar is always available:
#
#if test "$OS_ARCH" = "WINNT" -o \
#        "$OS_ARCH" = "Darwin"; then
#  MOZ_CAN_DRAW_IN_TITLEBARx=0
#fi
#